...
import { MantineProvider, Grid, Card, Image, Text, Badge, Button, Group } from '@mantine/core';
          ...
          return (
            <Grid.Col span={2} key={city.id}>
              <Card shadow="sm" padding="lg" radius="md" withBorder>
                ...
                <Text>Feels like {Math.round(city.main.feels_like)}ºC</Text>
                <Button component={Link} to={`/details/${city.name}`} color="blue" fullWidth mt="md" radius="md">Details</Button>
              </Card>
            </Grid.Col>
          )
        })}
